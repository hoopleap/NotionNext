...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || 'fbfe5d2d410a43c4aab925a1b6719f00',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '骏龙', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '分享Bot', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.storybus.fun', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'hoopleap@outlook.com', // 邮箱地址 例如mail@tangly1024.com
